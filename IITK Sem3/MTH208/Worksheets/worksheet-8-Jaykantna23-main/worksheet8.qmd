...
1.  The following website has the ODI rankings of cricket batters:
    ...
    <https://www.relianceiccrankings.com/ranking/womenodi/batting/>

    Using `html_table()`, extract the dataset of the 100 batters. Unfortunately, the data on the Country is not automatically extracted, so you will have to obtain that separately. Make sure the dataset is clean --- including the first column of the dataset.\
...
6.  For the `batting` dataset:
    ...
    b.  find the number of players from each team
